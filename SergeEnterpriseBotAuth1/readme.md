...
```shell
msbot clone services --name "SergeEnterpriseBotAuth1" --luisAuthoringKey "YOUR_AUTHORING_KEY" --folder "DeploymentScripts\YOUR_LOCALE_FOLDER" --location "westus"
```
...
```shell
az bot publish --name "SergeEnterpriseBotAuth1" --resource-group "SergeEnterpriseBotAuth1"
```
