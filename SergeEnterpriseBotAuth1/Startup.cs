...
using System;
using System.Linq;
using SergeEnterpriseBotAuth1.Dialogs.Main.Resources;
using SergeEnterpriseBotAuth1.Middleware;
using SergeEnterpriseBotAuth1.Middleware.Telemetry;
...
namespace SergeEnterpriseBotAuth1
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddBot<SergeEnterpriseBotAuth1>(options =>
            {
                // Load the connected services from .bot file.
